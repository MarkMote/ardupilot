...
public:
    ...
    void                output();
    void                output_signal(double *input);
    void                output_calibration(uint16_t value);
...
protected:
    ...
    virtual void        output_armed_new(double *input){};
    virtual void        output_calib(uint16_t input){};
