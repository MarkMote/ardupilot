/*
    ...
    (launcher GALauncher)
    Generated on: 25/02/2015 16:31:51.588
...
void PID_psi_init(t_PIDcontroller_state *_state_) {
...
void PID_psi_compute(t_PID_psi_io *_io_, t_PIDcontroller_state *_state_) {
    /*  Output from <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=dt>/<OutDataPort: name=>  */
    GAREAL dt;
    /*  Output from <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=u>/<OutDataPort: name=>  */
    GAREAL u;
    /*  Output from <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kp>/<OutDataPort: name=>  */
    GAREAL Kp;
    /*  Output from <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Ki>/<OutDataPort: name=>  */
    GAREAL Ki;
    /*  Output from <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kd>/<OutDataPort: name=>  */
    GAREAL Kd;
    ...
    GAREAL y_prev;
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=dt>  */
    dt = _io_->dt;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=dt>  */
    ...
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=u>  */
    u = _io_->u;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=u>  */
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Intergrator>/<SequentialBlock: name=u_prev>  */
    u_prev_7 = _state_->u_prev_memory_7;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Intergrator>/<SequentialBlock: name=u_prev>  */
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Intergrator>/<SequentialBlock: name=y_prev>  */
    y_prev = _state_->y_prev_memory_4;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Intergrator>/<SequentialBlock: name=y_prev>  */
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kp>  */
    Kp = _io_->Kp;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kp>  */
    ...
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Derivative>/<SequentialBlock: name=u_prev>  */
    u_prev_8 = _state_->u_prev_memory_8;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SystemBlock: name=Derivative>/<SequentialBlock: name=u_prev>  */
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Ki>  */
    Ki = _io_->Ki;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Ki>  */
    ...
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kd>  */
    Kd = _io_->Kd;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SourceBlock: name=Kd>  */
    ...
    /*  START Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SinkBlock: name=y>  */
    _io_->y = Sum;
    /*  END Block: <SystemBlock: name=PIDcontroller>/<SystemBlock: name=PID_psi>/<SinkBlock: name=y>  */
    ...
    _state_->u_prev_memory_8 = Divide2;
    ...
    _state_->u_prev_memory_7 = Divide1;
