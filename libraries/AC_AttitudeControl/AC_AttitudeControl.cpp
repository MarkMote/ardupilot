...
void AC_AttitudeControl::new_angle_ef_roll_pitch_yaw(float roll_angle_ef, float pitch_angle_ef, float yaw_angle_ef, bool slew_yaw)
{
    ...
    // body-frame to motor outputs should be called separately
    frame_conversion_ef_to_bf(_angle_ef_target, _angle_bf_target);
    ...
    angle_values[9] = _angle_bf_target.x;
    angle_values[10] = _angle_bf_target.y;
    angle_values[11] = _angle_bf_target.z;
